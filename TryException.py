...
o Try permite delimitar o código que pode gerar uma exceção. Ele é completado pela declaraçãp except. Se nenhum erro ocorrer,
o código dentro de except nem será executado. Dependendo do tipo da exceção, ima mensagem de erro diferente será exibida.
